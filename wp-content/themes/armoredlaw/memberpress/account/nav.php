  ...
  <nav id="mepr-account-nav" aria-label="<?php esc_attr_e('Account Navigation', 'memberpress'); ?>">
    <ul>
      <li class="mepr-nav-item <?php MeprAccountHelper::active_nav('home'); ?>">
        <a href="<?php echo esc_url(MeprHooks::apply_filters('mepr_account_nav_home_link', $account_url . $delim . 'action=home')); ?>" id="mepr-account-home"><?php echo esc_html(MeprHooks::apply_filters('mepr_account_nav_home_label', _x('Profile', 'ui', 'memberpress'))); ?></a>
      </li>
      ...
      <li class="mepr-nav-item">
        <a href="<?php echo esc_url(home_url('/logout/')); ?>" id="mepr-account-logout"><?php echo esc_html_x('Logout', 'ui', 'memberpress'); ?></a>
      </li>
    </ul>
  </nav>
</div>
