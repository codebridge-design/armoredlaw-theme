...
<div class="mp_wrapper">
  ...
  <h3 class="al-account__title"><?php esc_html_e('Profile Information', 'memberpress'); ?></h3>

  <p class="al-account__desc">
    <?php echo esc_html__('Manage your personal details and contact info.', 'armoredlaw'); ?>
  </p>
  ...
  <form class="mepr-account-form mepr-form" id="mepr_account_form" action="" method="post" enctype="multipart/form-data" novalidate>
    ...
    <?php if ($mepr_options->show_fname_lname) : ?>
      <div class="mp-form-row mepr_first_name<?php echo ($mepr_options->require_fname_lname) ? ' mepr-field-required' : ''; ?>">
        ...
        <input type="text" name="user_first_name" id="user_first_name" class="mepr-form-input" value="<?php echo esc_attr($mepr_current_user->first_name); ?>" placeholder="<?php echo esc_html_x('First Name*', 'ui', 'memberpress'); ?>" <?php echo ($mepr_options->require_fname_lname) ? 'required' : ''; ?> />
      </div>
      <div class="mp-form-row mepr_last_name<?php echo ($mepr_options->require_fname_lname) ? ' mepr-field-required' : ''; ?>">
        ...
        <input type="text" id="user_last_name" name="user_last_name" class="mepr-form-input" value="<?php echo esc_attr($mepr_current_user->last_name); ?>" placeholder="<?php echo esc_html_x('Last Name*', 'ui', 'memberpress'); ?>" <?php echo ($mepr_options->require_fname_lname) ? 'required' : ''; ?> />
      </div>
    <?php else : ?>
    ...
    <div class="mp-form-row mepr_email mepr-field-required">
      ...
      <input type="email" id="user_email" name="user_email" class="mepr-form-input" placeholder="<?php echo esc_html_x('Email*', 'ui', 'memberpress');  ?>" value="<?php echo esc_attr($mepr_current_user->user_email); ?>" required />
    </div>

		<h3 class="al-account__title"><?php esc_html_e('Address', 'memberpress'); ?></h3>
  ...
  <p class="al-account__desc al-account__desc-bottom">
    <?php echo esc_html__('Your personal data is encrypted and securely stored.', 'armoredlaw'); ?>
  </p>
</div>
